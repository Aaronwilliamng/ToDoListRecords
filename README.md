...
- [x] 背包问题:leetcode 139,322, 377, 416, 474, 494

2020.7.11

- [x] 最大和谐子序列 - 双指针 & 哈希表 两种写法
- [x] 最大公共子序列 - dp[i] [j]
- [ ] 大疆测评
- [ ] 面经
...
- [x] 职业规划
- [ ] 通信行业的认识
- [x] 公司的认识(网络、通讯设备、服务器、手机、无线、芯片 7nm量产 5nm研发)
- [ ] 选择公司考虑的因素(国有控股)
- [x] 为什么想来? / 我们为什么要你? / 你的最大特点 / 优点(专业技能 服务器; 带来活力 举例)
- [x] 成就感的事(学习能力 羽球 画画 写字 摄影)
- [x] 挫败感的事 / 失败的经历 / 缺点(关键时候争取 出国机会 多想方法; 并发安排任务 时间耗时的把控)
- [x] 薪资情况
...
- [x] 设计模式: 单例模式(饿汉和懒汉)
- [ ] 线程安全如何判断
- [ ] extern和static(访问范围, 什么时候出错)
- [ ] const(存储空间)
- [x] 编程: 两种方法链表翻转
- [ ] 编程: 最大上升子序列
- [ ] get post push什么场景(远程连接数据库)
- [ ] 内存泄漏在编程中表现
- [ ] 编程: 一棵树从左边看，输出看到的结点
- [x] 编程: 用两个栈实现队列
- [ ] 定时器实现，用什么数据结构？时间复杂度？
- [ ] 快排和堆排选择?什么时候用哪个？（快排用到了递归，可能会有栈层数过高的问题，了解stl中的sort的话
- [x] lambda表达式
- [ ] 指针和引用的区别
- [ ] 锁的分类
- [ ] 游戏帧率太低可能是什么原因引起的？某位玩家延迟较高怎么解决？
- [ ] 迭代器失效的情况
- [ ] ET LT
- [ ] 编程：以k为单位反转链表，如k=3，1→2→3→4→5→6→7→8反转为3→2→1→6→5→4→8→7，注意最后一组是8→7
- [ ] 程序是怎么存储在地址空间
- [ ] 虚拟地址到物理地址的映射
- [ ] Linux系统怎么分配内存
- [ ] 共享内存如何实现? 系统分配还是指定
- [ ] fork函数 与 vfork区别
- [ ] 线程需要保存那些上下文 sp pc eax寄存器是做什么的
- [ ] shared_ptr实现
...
- [x] 超键, 候选键, 主键
- [ ] 关系型数据库和非关系型数据库
- [x] 联合索引: left join , inner join, cross join
- [x] 乐观锁, 悲观锁
...
- [ ] 设计模式(单例模式)
- [x] linux指令(cpu占有 面试常问的命令)
- [x] fork创建子进程过程
- [x] 进程 上下文切换 程序计数器pc 寄存器
- [ ] linux关闭终端窗口发生了什么
- [x] 僵尸进程 
- [ ] 算法: 随机数 打乱数组
- [ ] 锁(标准库中锁 怎么用)
- [ ] 数组模拟链表怎么用 !!!
- [x] 预分配 线程池(常见问题 如线程数怎么确定)
- [x] TCP UDP
- [x] main函数执行前 执行哪些代码
- [ ] 缓存 一致性
